...
const TodaysPlanButton = ({ workout }: { workout: IWorkoutType }) => {
    ...
    return (
        <div>
              <button className="flex-1 bg-[#a3e635] text-black font-extrabold uppercase py-3.5 px-5 rounded-xl hover:bg-[#8ece25] transition-colors flex items-center justify-center gap-2 text-xs sm:text-sm" onClick={handleAddToTodaysPlan}>
